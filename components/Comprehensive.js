        ...
        <>
            <div className={styles.comprehensive}>
                ...
                <Container>
                    ...
                    <Row>
                        <Col xl={12}>
                            <h2 className="fw900 font48 color-blue font-f t-center">Our Comprehensive Services Include</h2>
                                    ...
                                    <div className={styles.flipcard}>
                                        <div className={styles.flipcardinner}>
                                            <div className={`${styles.flipcardfront}  ${styles.flipcardfront1}`}>
                                                <Image className='img-fluid' src={item.image} alt="cardimg"></Image>
                                                <h1>{item.subTitle}</h1>
                                            </div>
                                    ...
                                    <div className={styles.flipcard}>
                                        <div className={styles.flipcardinner}>
                                            <div className={styles.flipcardfront}>
                                                <Image className={`${styles.newimg} img-fluid`} src={item.image}  alt="cardimg"></Image>
                                            </div>
                                            <div className={styles.flipcardback}>
                                                <h1>{item.title}</h1>
                                                <p>{item.pra}</p>
