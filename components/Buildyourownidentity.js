...
<Container>
    <Row className='mb-3'>
        <Col> 
        <h2 class="fw900 font48 color-blue font-f mb-2 t-center">Build Your Own Identity</h2>
...
<Image src={buildyourownidentity} className='img-fluid' alt='buildyourownidentity'></Image>
