...
// images 
import footerlogo from '../public/images/footer/logofooter.png'
...
<Container>
    ...
    <Row className='pt-3'>
        <Col md={12}>
            ...
            <p className='font14 text-center'> <Link className={styles.styleset} href="#">Terms of Use</Link> | <Link className={styles.styleset} href="#">Privacy Policy</Link></p>
        </Col>
    </Row>
</Container>
</div>
