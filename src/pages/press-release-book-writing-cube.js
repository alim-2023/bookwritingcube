  ...
  const bannertext=[
    {
      ...
      alignclass: 'release',
      pra: 'Book Writing Cube Sets The Record Straight On Domain Ownership',
        ...
        <Row>
            ...
            <p className= 'font15 fw500 font-f'> <strong>Beaverton, Oregon, March 28, 23</strong>  – Book Writing Cube, a leading provider of book writing and
                    ...
                    <ul>
                        ...
                        <li className='font-f'><strong>Email: </strong> info@bookwritingcube.com
                        </li>
                        <li className='font-f'><strong>Phone: </strong> (302) 883-8877
                        </li>
